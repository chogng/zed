        ...
        *hints.lock() = Some(vec![type_hint(21, "u32", HintEdits::InResponse)]);
        ...
        cx.update_editor(|editor, window, cx| {
            ...
            editor.change_selections(SelectionEffects::no_scroll(), window, cx, |selections| {
                selections.select_ranges([Point::new(0, 12)..Point::new(0, 13)]);
            });
        });
        cx.run_until_parked();
        cx.update(|window, cx| {
        ...
        cx.update_editor(|editor, _, _| editor.selections.set_line_mode(false));
        cx.dispatch_action(AcceptInlayHint);
        cx.run_until_parked();
        assert_eq!(
            cx.buffer_text(),
        ...
        cx.update_editor(|editor, _, _| editor.selections.set_line_mode(true));
        cx.dispatch_action(AcceptInlayHint);
        cx.run_until_parked();
